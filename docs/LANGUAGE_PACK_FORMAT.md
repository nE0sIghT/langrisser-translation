...
| `fullwidth_units` | Optional uppercase labels — whole runs, not fragments — that must encode as centred full-size glyphs, one per letter, rather than compact pairs. |
